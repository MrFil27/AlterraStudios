...
if(isset($_GET['teacher']) && isset($_GET['user']) && isset($_GET['class'])){
    $student_id      = intval($_GET['teacher']);
    ...
    $stmt = $conn->prepare("DELETE FROM docenti_classi WHERE user_id = ? AND classe_id = ?");
